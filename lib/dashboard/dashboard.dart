...
class _DashboardState extends State<Dashboard> {
  ...
  void _checkPermissionAndDownloadFile({required String link,required String name}) async {
        ...
        showDialog(
            ...
            builder: (ctx){
              return  AlertDialog(
                ...
                content: Text('storage permission required to provide file downloading feature'),
                actions: [
                  TextButton(
                    child: Text('Cancel'),
                    onPressed: (){
  ...
  void _download(var link,var filename) async {
    ...
    var options = DownloaderUtils(
      progressCallback: (current, total) {
        ...
        LocalNotificationService.display(null,progress.toInt(),"$filename.pdf");
        },
